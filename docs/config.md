...
_See code: [src/commands/config/destroy.js](https://github.com/getstream/stream-cli/blob/v0.0.19/src/commands/config/destroy.js)_
...
_See code: [src/commands/config/get.js](https://github.com/getstream/stream-cli/blob/v0.0.19/src/commands/config/get.js)_
...
_See code: [src/commands/config/set.js](https://github.com/getstream/stream-cli/blob/v0.0.19/src/commands/config/set.js)_
