...
* [`stream chat:channel:invite`](#stream-chatchannelinvite)
...
OPTIONS
  -c, --channel=channel                                 The ID of the channel you wish to invite a user to.

  -j, --json                                            Output results in JSON. When not specified, returns output in a
                                                        human friendly format.

  -m, --members=members                                 Comma separated list of members to invite.
