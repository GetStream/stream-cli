...
class ChannelUpdateType extends Command {
	async run() {
		const { flags } = this.parse(ChannelUpdateType);
		...
		try {
			if (!flags.type) {
				const res = await prompt([
					...
					},
					{
						...
						required: true,
						choices: [ { message: 'Yes', value: true }, { message: 'No', value: false } ]
					},
					{
						type: 'select',
						name: 'read_events',
					...
					},
					{
						...
						required: true,
						choices: [
							{ message: 'Simple', value: 'simple' },
							{ message: 'AI', value: 'AI' },
							{ message: 'Disabled', value: 'disabled' }
						]
					},
					{
						type: 'select',
						...
						required: false,
						choices: [
							{ message: 'Infinite', value: 'infinite' },
							{ message: '30', value: '30' },
							{ message: '60', value: '60' },
							{ message: '90', value: '90' },
							{ message: '120', value: '120' },
							{ message: '150', value: '150' },
							{ message: '180', value: '180' },
							{ message: '210', value: '210' },
							{ message: '240', value: '240' },
							{ message: '270', value: '270' },
							{ message: '300', value: '300' },
							{ message: '330', value: '330' },
							{ message: '360', value: '360' }
						]
					}
				]);
			...
			this.log(`Channel type ${chalk.bold(flags.type)} has been updated.`);
			this.exit();
		} catch (error) {
